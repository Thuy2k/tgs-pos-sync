    ...
    <?php if ($is_registered): ?>
        ...
        <div class="notice notice-info" style="padding: 20px; margin: 20px 0;">
            <h2 style="margin-top: 0;">
                ...
                <?php _e('Bước tiếp theo', 'tgs-pos-sync'); ?>
            </h2>
            <p><?php _e('Đã kết nối Hub thành công! Giờ cần tạo bảng dữ liệu.', 'tgs-pos-sync'); ?></p>
            <p>
                <a href="<?php echo admin_url('admin.php?page=tgs-pos-schema'); ?>" class="button button-primary button-large">
                    <span class="dashicons dashicons-database-add" style="margin-top: 3px;"></span>
                    <?php _e('Đi đến Cấu trúc Schema', 'tgs-pos-sync'); ?>
                </a>
            </p>
        </div>
